...
*/
var vgp = require('./build/Debug/vgp.node');
...
var cipherText = vgp.Encrypt(new Buffer(publicKeys, 'utf8'), new Buffer(message, 'utf8'));
...
var decryptedMessage1 = vgp.Decrypt(new Buffer(privateSeed1, 'utf8'), new Buffer(cipherText, 'utf8'));
...
var decryptedMessage2 = vgp.Decrypt(new Buffer(privateSeed2, 'utf8'), new Buffer(cipherText, 'utf8'));
